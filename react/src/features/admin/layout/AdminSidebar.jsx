...
export default function AdminSidebar() {
  ...
  const inactiveClasses = "text-gray-100 hover:bg-red-700/70 hover:text-white";
  ...
  return (
    <aside className="flex flex-col w-64 bg-gradient-to-b from-red-700 to-red-900 text-white border-r border-red-900">
      ...
      >
        ...
        <div>
          <p className="text-xs uppercase tracking-widest text-red-100">Panel</p>
          <p className="text-lg font-extrabold tracking-wide">SwappLynk Admin</p>
        </div>
      </div>
