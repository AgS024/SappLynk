...
export default function Wishlist() {
    ...
    const handleEliminar = (cartaId) => {
        if (window.confirm('¿Eliminar de tu wishlist?')) {
            axiosClient.delete(`/wishlist/${cartaId}`)
                .then(() => {
                    cargarWishlist();
    ...
    return (
        ...
        >
            {loading ? (
                ...
                <div className="text-center py-12">
                    <p className="text-gray-500 mb-4 text-lg">Tu wishlist está vacía</p>
                    <TButton color="indigo" to="/explorar-cartas">
                        🔍 Explorar Cartas
                    </TButton>
                </div>
                ...
                <>
                    <div className="mb-4 text-gray-600">
                        Cartas en wishlist: <span className="font-bold text-red-600">{wishlist.length}</span>
                    </div>
